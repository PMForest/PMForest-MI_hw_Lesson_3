...
class ScrapingJob():
    ...
    def __init__(self, mongodb_uri, db_name, collection_name):
        self.headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64)'\ 
                          ...
                          'YaBrowser/21.2.2.101 Yowser/2.5 Safari/537.36'
        }
        self.link_hh = 'https://hh.ru/search/vacancy?' \
                       'clusters=true&enable_snippets=true&salary=&st=searchVacancy&text=python'
    ...
    def _parser_item_hh(self, item):
        ...
        # link
        vacancy_data['vacancy_link'] = (f'https://hh.ru/search/vacancy?' \
                                        'clusters=true&enable_snippets=true&salary=&st=searchVacancy&text=python'
                )
